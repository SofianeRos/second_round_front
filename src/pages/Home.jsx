    ...
    <div className="w-full min-h-screen bg-black flex flex-col">
      ...
      <section className="w-full bg-black py-16 flex justify-center">
        <div className="w-full max-w-[1300px] px-4 md:px-8">
          ...
          <div
            className="flex flex-row space-x-6 sm:space-x-8 md:space-x-12 lg:space-x-16 w-full overflow-x-auto mt-8 pb-4"
            style={{ scrollbarWidth: "none", msOverflowStyle: "none" }}
          >
            {filteredArticles.slice(0, 4).map((item) => (
              <div
                key={item.id}
                className="min-w-[160px] md:min-w-[220px] lg:min-w-0 flex-1 flex flex-col cursor-pointer group"
