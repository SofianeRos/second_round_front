      ...
      <div className="w-full min-h-screen bg-black flex flex-col">
        ...
        >
          ...
          <div className="flex-1 flex flex-col justify-center items-end px-8 md:px-16 lg:px-24">
            ...
            <div className="flex flex-col items-center w-full max-w-[500px]" style={{ gap: "40px" }}>
          ...
          <div style={{ width: "100%", paddingBottom: "40px", display: "flex", justifyContent: "center" }}>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", width: "100%", maxWidth: "900px", padding: "0 20px" }}>
              ...
              >
                <svg width="180" height="180" viewBox="0 0 481 476" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-24 h-24 md:w-32 md:h-32 lg:w-40 lg:h-40 mb-6 group-hover:scale-110 transition-transform duration-300">
                  <g clipPath="url(#clip1)">
                    <path d="M189.524 53H191.169C204.014 53 214.447 63.4727 214.447 76.3747V214.629C214.447 227.527 204.018 238.004 191.169 238.004H189.524C176.679 238.004 166.246 227.531 166.246 214.629V76.3747C166.246 63.4727 176.679 53 189.524 53Z" fill="#FF0000"/>
                    <path d="M158.652 214.625V76.371C158.652 75.8554 158.666 75.3397 158.691 74.8277C156.901 74.2394 154.992 73.9163 153.007 73.9163C142.921 73.9163 134.719 82.152 134.719 92.2834V198.713C134.719 208.841 142.921 217.076 153.007 217.076C154.992 217.076 156.901 216.753 158.691 216.165C158.666 215.653 158.652 215.141 158.652 214.622V214.625Z" fill="#FF0000"/>
                    <path d="M127.125 111.831C126.235 111.671 125.324 111.58 124.391 111.58C115.911 111.58 109 118.505 109 127.035V163.969C109 172.495 115.911 179.424 124.391 179.424C125.324 179.424 126.235 179.333 127.125 179.173V111.831Z" fill="#FF0000"/>
                    <path d="M290.831 53H292.476C305.321 53 315.754 63.4727 315.754 76.3747V214.629C315.754 227.527 305.325 238.004 292.476 238.004H290.831C277.986 238.004 267.553 227.531 267.553 214.629V76.3747C267.553 63.4763 277.982 53 290.831 53Z" fill="#FF0000"/>
                    <path d="M323.348 214.625V76.371C323.348 75.8554 323.334 75.3397 323.309 74.8277C325.099 74.2394 327.008 73.9163 328.993 73.9163C339.079 73.9163 347.281 82.152 347.281 92.2834V198.713C347.281 208.841 339.079 217.076 328.993 217.076C327.008 217.076 325.099 216.753 323.309 216.165C323.334 215.653 323.348 215.141 323.348 214.622V214.625Z" fill="#FF0000"/>
                    <path d="M354.875 111.831C355.765 111.671 356.676 111.58 357.609 111.58C366.089 111.58 373 118.505 373 127.035V163.969C373 172.495 366.089 179.424 357.609 179.424C356.676 179.424 355.765 179.333 354.875 179.173V111.831Z" fill="#FF0000"/>
                    <path d="M258.722 128.342H223.282V162.658H258.722V128.342Z" fill="#FF0000"/>
                  </g>
                  <defs>
                    <clipPath id="clip1">
                      <rect width="264" height="185" fill="white" transform="translate(109 53)"/>
                    </clipPath>
                  </defs>
                </svg>
                <h3 className="text-xl md:text-2xl lg:text-3xl font-bold text-white mb-2 uppercase tracking-wide text-center">Les Équipements</h3>
                <p className="text-gray-400 text-sm md:text-base text-center font-light">Comprendre chaque équipement et à quoi il sert.</p>
              </div>
              ...
              >
                <svg width="180" height="180" viewBox="0 0 481 476" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-24 h-24 md:w-32 md:h-32 lg:w-40 lg:h-40 mb-6 group-hover:scale-110 transition-transform duration-300">
                  <g clipPath="url(#clip2)">
                    <path d="M182.873 142.243L195.276 121.502C196.074 120.162 197.551 119.332 199.133 119.332C199.213 119.332 199.296 119.332 199.376 119.338C201.04 119.427 202.504 120.43 203.204 121.954L218.514 156.175L238.765 95.4912C239.366 93.6678 241.075 92.4395 243.012 92.4395C245.031 92.4618 246.728 93.741 247.291 95.6248L268.136 164.951L277.253 145.374C277.985 143.806 279.582 142.794 281.318 142.794H341.868C346.298 126.339 346.048 109.162 340.993 91.6121C340.954 91.5039 340.919 91.4339 340.919 91.3639C336.142 76.8916 321.701 58.4733 296.708 53.9929C293.634 53.3533 264.975 48.09 240.979 70.4191C217.025 48.0868 188.363 53.3501 185.289 53.9897C160.296 58.4702 145.855 76.8884 141.081 91.3607C141.081 91.4308 141.043 91.5039 141.007 91.609C136.006 108.964 135.712 125.954 139.991 142.243H182.873Z" fill="#FF0000"/>
                    <path d="M284.165 151.7L271.29 179.356C270.555 180.925 268.96 181.934 267.231 181.934C267.123 181.934 267.017 181.931 266.908 181.921C265.049 181.788 263.454 180.508 262.94 178.736L242.788 111.685L223.368 169.877C222.786 171.637 221.205 172.836 219.338 172.925L219.121 172.932C217.351 172.932 215.747 171.891 215.034 170.284L198.554 133.448L189.264 148.986C188.427 150.335 186.96 151.153 185.42 151.153H142.822C149.492 169.081 161.852 186.055 179.773 201.587C206.914 225.125 236.946 237.001 238.202 237.465C239.091 237.822 240.052 238 240.979 238C241.906 238 242.906 237.822 243.795 237.465C245.054 237.004 275.083 225.128 302.223 201.587C319.962 186.211 332.253 169.425 338.97 151.697H284.165V151.7Z" fill="#FF0000"/>
                  </g>
                  <defs>
                    <clipPath id="clip2">
                      <rect width="208" height="185" fill="white" transform="translate(137 53)"/>
                    </clipPath>
                  </defs>
                </svg>
                <h3 className="text-xl md:text-2xl lg:text-3xl font-bold text-white mb-2 uppercase tracking-wide text-center">Bien Débuter</h3>
                <p className="text-gray-400 text-sm md:text-base text-center font-light">Conseil sécurité et entraînement.</p>
              </div>
